...
stoch_model = spm.solve_stochastic_model(x, y)
...
ax.legend()
fig.savefig('01_1d_likelihood.png', dpi=600)
...
fig.savefig('01_1d_predictor.png', dpi=600)
...
for k in range(n):
    ...
    cv_model = spm.solve_stochastic_model(xm, ym)
    mu_hat = cv_model['mu']
...
fig2.savefig('01_1d_crossvalidation.png', dpi=600)
plt.show()

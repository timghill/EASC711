...
SM = spm.solve_stochastic_model(x, y, x0=theta0, p=[2, 2], method='SLSQP')
...
fig.savefig('01_branin_predictor.png', dpi=600)
...
cvfig.savefig('01_branin_crossvalidation.png', dpi=600)
